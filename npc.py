...
class NPC(AnimatedSprite):
    def __init__(self, game, path="resources/sprites/npc/alien/0.png", pos=(4.5, 5.5),
        ...
        self.alive = True
        self.pain = False
        self.ray_cast_calue = False
        self.frame_counter = 0
        self.player_serch_trigger = False
    ...
    def run_logic(self):
        if self.alive:
            ...
            if self.pain:
                ...
                self.player_serch_trigger = True
            ...
            elif self.player_serch_trigger:
                self.animate(self.walk_images)
                self.movement()
    ...
    def ray_cast_player_npc(self):
        ...
        for i in range(MAX_DEPTH):
            ...
            if tile_hor in self.game.map.world_map:
                #sprawdzamy typ (cyferkę) sciany którą widzi gracz
        ...
        player_dist = max(player_dist_v, player_dist_h) #tutaj
